...
# -----------------------------
df = pd.read_csv("Project 1/2D/gold_supersonic/my1_5_model_supersonic.csv")
t_ns_csv = df["x"].to_numpy()
z_F_cm_csv = df["y"].to_numpy()
...
# -----------------------------
df = pd.read_csv("Project 1/2D/data/1ns.csv")
plt.plot(df["x"].to_numpy(), df["y"].to_numpy(), linestyle="--", label="1ns - simulation", color="black")

df = pd.read_csv("Project 1/2D/data/2ns.csv")
plt.plot(df["x"].to_numpy(), df["y"].to_numpy(), linestyle="--", label="2ns - simulation", color="red")

df = pd.read_csv("Project 1/2D/data/2.5ns.csv")
plt.plot(df["x"].to_numpy(), df["y"].to_numpy(), linestyle="--", label="2.5ns - simulation", color="blue")
